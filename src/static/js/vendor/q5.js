export function q5({ parent, width, height }, events) {
  return new graphics(parent, events);
  function graphics(parent, events = {}) {
    let $ = this;
    ...
    window.ondevicemotion = function (event) {
      ...
      if (!event.acceleration) {
        ...
        // g = ~ 9.80665
        let grav = TRFM(MULT(ROTY($.rotationY), ROTX($.rotationX)), [
          0,
          0,
          -9.80665,
        ]);
